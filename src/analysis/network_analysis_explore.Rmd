...
df_graphs <- df_trials_weights %>% 
  ...
  mutate(smallworldness = map_dbl(graph, ~smallworldness(.)["smallworldness"])) %>% # computationally expensive
...
```{r}
get.adjacency(df_graphs_survey$graph[[1]], attr="weighted", sparse=FALSE)
```
